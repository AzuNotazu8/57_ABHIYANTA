        ...
        <div className={styles.modalHead}>
          <div className={styles.modalTitle}>
            ...
            <div>
              ...
              <p className={styles.titleSub}>Generated from 20-year AETHERA cascade simulation · Sundarbans</p>
            </div>
          </div>
        ...
        <div className={styles.modalBody}>
          {!report && !loading && !error && (
            <div className={styles.promptState}>
              ...
              <p className={styles.promptDesc}>
                AETHERA will analyse all 20 years of simulation data — flood risk, glacier melt,
                animal migration patterns, and zoonotic exposure — and produce a structured
          ...
          {loading && (
            <div className={styles.loadingState}>
              ...
              <p className={styles.loadText}>Analysing 20 years of cascade data…</p>
              <p className={styles.loadSub}>This takes 10–20 seconds</p>
            </div>
          )}
            ...
            <div className={styles.errorState}>
              ...
              {error.includes('API key') && (
                <div className={styles.errorHint}>
                  ...
                  <code className={styles.codeBlock}>ANTHROPIC_API_KEY=sk-ant-…your key…</code>
          ...
          {sections.length > 0 && (
            <div className={styles.report}>
              ...
              <div className={styles.reportFoot}>
                <span>Generated by Claude · AETHERA v2.0 · Baseline scenario · Synthetic data</span>
                <button className={styles.regenBtn} onClick={generate}>↻ Regenerate</button>
              </div>
            </div>
          )}
        </div>
